...
<!-- <title>Trang chủ</title> -->
	...
	<body>
	 <%@ include file="/common/admin/header.jsp" %> 
		...
		<form action="<c:url value='/adnin/quan-tri/bai-viet/danh-sach'/>" id="formSubmit" method="get">
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createNewURL" value="/admin/quan-tri/bai-viet/chinh-sua"/>
												<a flag="info"
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>
																<c:url var="updateNewURL" value="/admin/quan-tri/bai-viet/chinh-sua">
